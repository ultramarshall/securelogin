 ...
 */
define("HOST", "dikoding.cloudapp.net"); 			// The host you want to connect to. 
define("PORT", "24555"); 			// port 
define("USER", "user_kami"); 			// The database username. 
define("PASSWORD", "123"); 	// The database password. 
define("DATABASE", "ultramarshall_loginsecure");             // The database name.
